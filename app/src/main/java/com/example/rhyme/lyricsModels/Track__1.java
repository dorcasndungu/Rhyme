...
public class Track__1 {
    ...
    @Expose
    private List<TrackNameTranslation> trackNameTranslationList = null;
     ...
     * @param commontrackId
     */
    public Track__1(Integer trackId, String trackName, List<TrackNameTranslation> trackNameTranslationList, Integer trackRating, Integer commontrackId, Integer instrumental, Integer explicit, Integer hasLyrics, Integer hasSubtitles, Integer hasRichsync, Integer numFavourite, Integer albumId, String albumName, Integer artistId, String artistName, String trackShareUrl, String trackEditUrl, Integer restricted, String updatedTime, PrimaryGenres primaryGenres) {
        super();
    ...
    public List<TrackNameTranslation> getTrackNameTranslationList() {
        return trackNameTranslationList;
    }

    public void setTrackNameTranslationList(List<TrackNameTranslation> trackNameTranslationList) {
        this.trackNameTranslationList = trackNameTranslationList;
    }
